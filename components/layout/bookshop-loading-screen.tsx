      ...
      <div className="flex flex-col items-center">
        <div className="loading-logo-entrance mb-6">
          <svg width="56" height="56" viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg" className="drop-shadow-sm">
            <circle cx="50" cy="18" r="7" className="loading-sun" fill="#e5444c" opacity="0.9" />
            <path d="M12 24 Q12 22 14 22 L36 22 L36 56 L14 56 Q12 56 12 54 Z" fill="#5b5f94" opacity="0.6" />
            <path d="M36 22 L58 22 Q60 22 60 24 L60 54 Q60 56 58 56 L36 56 Z" fill="#2d2f92" opacity="0.9" />
            <path d="M36 22 L36 56" stroke="#faf7f0" strokeWidth="1.5" opacity="0.5" />
          </svg>
        </div>
        <p className="text-[13px] font-medium text-[#5b5f94]/70">正在准备…</p>
